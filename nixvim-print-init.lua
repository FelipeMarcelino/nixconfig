...
require("lz.n").load({
    ...
    },
    {
        "markview.nvim",
        after = function()
            require("markview").setup({ hybrid_modes = { "i", "r" }, modes = { "n", "x", "i", "r" } })
        end,
        ft = "markdown",
    },
    {
...
require("mini.snippets").setup({
    snippets = {
        require("mini.snippets").gen_loader.from_file(
            "/nix/store/3n8czyl7i517bgqy1ccdn9wf1wdsandf-vimplugin-friendly-snippets-2024-12-02/snippets/global.json"
        ),
            ...
            extraOptions = {
                settings = {
                    ["nil"] = {
                        formatting = {
                            command = {
                                "/nix/store/lch913ar0a3w3f6d63crf5vfvpckddk1-nixfmt-unstable-2024-12-04/bin/nixfmt",
                            },
                        },
...
require("conform").setup({
    ...
    formatters = {
        ...
        csharpier = { command = "/nix/store/rsipd3sz9jmmapl8gld53cjbsix2xgdz-csharpier-0.30.5/bin/dotnet-csharpier" },
        deno_fmt = { command = "/nix/store/5b578i7qa3mybk98s4qlmhz3w3cvzc90-deno-2.1.5/bin/deno" },
        fantomas = { command = "/nix/store/8g9shl9wzv05r1ra1jx9dy1hcd8s81p6-fantomas-7.0.0/bin/fantomas" },
        ...
        ruff = { command = "/nix/store/sjw691v6hj3l3662vxf490js0czyq8f4-ruff-0.9.1/bin/ruff" },
        ...
        sqlfluff = { command = "/nix/store/5g4kgqslh8spf514xvcs8f4501ribz8a-sqlfluff-3.3.0/bin/sqlfluff" },
        squeeze_blanks = { command = "/nix/store/4s9rah4cwaxflicsk5cndnknqlk9n4p3-coreutils-9.5/bin/cat" },
        stylelint = { command = "/nix/store/fv1rwj1j437bgz9scn0w2jgizzq4bsib-stylelint-16.13.0/bin/stylelint" },
        ...
        terraform_fmt = { command = "/nix/store/8wc5zvj59rpr7gsvrwdfdi7nkrpsybn4-terraform-1.10.4/bin/terraform" },
        xmlformat = { command = "/nix/store/vv32rqb4l30kjii00ivpnf8i5pxzf72g-xmlformat-1.04/bin/xmlformat" },
        yamlfmt = { command = "/nix/store/4wjplfjk7h06v065vd8k1mr93rrgnsvn-yamlfmt-0.15.0/bin/yamlfmt" },
