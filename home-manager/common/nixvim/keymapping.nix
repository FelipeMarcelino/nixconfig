  ...
  programs.nixvim = {
    keymaps = [
      ...
      }
      {
        ...
        key = "<leader>zn";
        options.silent = true;
        options.desc = "Create a new note with specified title";
      }
      {
        action = ":ZkNotes { sort = {'modified'} }<CR>";
        key = "<leader>zo";
        options.silent = true;
        options.desc = "Open zk notes without search";
      }
      {
        action = ":ZkTags<CR>";
        key = "<leader>zt";
      ...
      }
      {
        ...
        key = "<leader>zf";
        options.silent = true;
        options.desc = "Opens notes sorted by modified date with search ";
      }
      {
        action = ":'<,'>ZkMatch<CR>";
        key = "<leader>zf";
        options.silent = true;
        mode = "v";
        options.desc = " Opens a notes picker, filters for notes that match the text in the last visual selection ";
      }
    ];
    ...
    files."after/ftplugin/markdown.lua" = {
      keymaps = [
        ...
        }
        {
          ...
          options.silent = true;
          mode = "v";
          options.desc = "Create a note with the title from visual selected text";
        }
        {
          ...
          options.silent = true;
          mode = "v";
          options.desc = "Create a new note using the visual selected text as content";
        }
        {
          action = "<Cmd>ZkBacklinks<CR>";
          key = "<leader>zb";
          options.silent = true;
          options.desc = "Show notes backlinks";
        }
        {
          action = "<Cmd>ZkLinks<CR>";
          key = "<leader>zl";
          options.silent = true;
          options.desc = "Show notes links";
        }
        {
